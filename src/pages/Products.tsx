                  ...
                  <div className="p-6">
                    ...
                    <div className="flex gap-2">
                      ...
                      <button 
                        ...
                        className="flex-1 bg-gradient-to-r from-saikou-primary to-saikou-accent text-saikou-secondary py-3 rounded-lg font-darker-grotesque font-semibold hover:shadow-lg transition-all"
                      >
                        Add to Cart
                      </button>
                    </div>
