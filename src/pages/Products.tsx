        ...
        <section className="pt-32 pb-8 bg-gradient-to-br from-saikou-background via-white to-saikou-background">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12 animate-fade-in">
              <h1 className="text-4xl md:text-5xl font-space-grotesk font-bold mb-4 bg-gradient-to-r from-saikou-secondary to-saikou-accent bg-clip-text text-transparent transform hover:scale-105 transition-transform duration-300">
          ...
          <div className="container mx-auto px-4">
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {allProducts.map((product, index) => (
                <div 
                  key={product.id} 
                  className="bg-white/80 backdrop-blur-sm rounded-xl shadow-lg overflow-hidden hover:shadow-xl hover:scale-105 transition-all duration-300 border border-gray-100 group transform animate-fade-in"
                ...
                >
                  <div className="relative h-80 overflow-hidden">
                    ...
                    />
                    <div className="absolute top-4 right-4 bg-gradient-to-r from-saikou-accent to-saikou-primary text-white px-3 py-1 rounded-full text-sm font-darker-grotesque font-semibold shadow-lg transform hover:scale-110 transition-transform duration-300">
                      {product.badge}
                    </div>
                  </div>
                  <div className="p-6">
                    <h3 className="text-xl font-space-grotesk font-semibold mb-2 text-saikou-secondary group-hover:text-saikou-accent transition-colors duration-300">{product.name}</h3>
                    ...
                    <div className="flex gap-2">
                      <Link 
                        ...
                        className="flex-1 bg-saikou-background text-saikou-secondary py-3 rounded-lg font-darker-grotesque font-semibold hover:bg-saikou-primary hover:scale-105 transition-all duration-300 text-center transform"
                      >
                        View Details
                      </Link>
                      <button 
                        onClick={() => addToCart(product.id, product.name, product.price)}
                        className="flex-1 bg-gradient-to-r from-saikou-primary to-saikou-accent text-saikou-secondary py-3 rounded-lg font-darker-grotesque font-semibold hover:shadow-lg hover:scale-105 transition-all duration-300 transform"
                      >
                        Add to Cart
                      </button>
                    </div>
